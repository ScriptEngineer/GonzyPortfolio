                                      ...
                                      <g transform="matrix(2.28754,0,0,-2.28754,-775.044,1604.98)">
                                        <g id="g672">
                                          ...
                                          <g id="g694" transform="matrix(1,0,0,1,350.495,680.948)">
                                            <path id="path696" d="M0,0C-3.781,0 -6.846,-3.065 -6.846,-6.846C-6.846,-10.628 -3.781,-13.693 0,-13.693C3.781,-13.693 6.846,-10.628 6.846,-6.846L6.84,-6.555L6.84,0L0,0Z" style={{fill:'currentColor',fillRule:'nonzero'}} />
                                          </g>
                                          ...
                                          <g id="g702" transform="matrix(1,0,0,1,353.495,675.7)">
                                            <path id="path704" d="M0,0C-2.674,-2.674 -2.674,-7.009 0,-9.682C2.674,-12.356 7.009,-12.356 9.682,-9.682C12.356,-7.009 12.356,-2.674 9.682,0L9.472,0.202L4.837,4.837L0.012,0.011L0,0Z" style={{fill:'currentColor',fillRule:'nonzero'}} />
                                          </g>
                                          ...
                                          <g id="g710" transform="matrix(1,0,0,1,359.327,674.109)">
                                            <path id="path712" d="M0,0C0,-3.781 3.065,-6.846 6.846,-6.846C10.628,-6.846 13.693,-3.781 13.693,0C13.693,3.781 10.628,6.846 6.846,6.846L6.554,6.84L0,6.84L0,0Z" style={{fill:'currentColor',fillRule:'nonzero'}} />
                                          </g>
                                          ...
                                          <g id="g718" transform="matrix(1,0,0,1,364.575,677.109)">
                                            <path id="path720" d="M0,0C2.674,-2.674 7.009,-2.674 9.682,0C12.356,2.674 12.356,7.009 9.682,9.682C7.009,12.356 2.674,12.356 0,9.682L-0.202,9.471L-4.837,4.837L0,0Z" style={{fill:'currentColor',fillRule:'nonzero'}} />
                                          </g>
                                          ...
                                          <g id="g726" transform="matrix(1,0,0,1,366.165,682.941)">
                                            <path id="path728" d="M0,0C3.781,0 6.846,3.065 6.846,6.846C6.846,10.628 3.781,13.693 0,13.693C-3.781,13.693 -6.846,10.628 -6.846,6.846L-6.84,6.555L-6.84,0L0,0Z" style={{fill:'currentColor',fillRule:'nonzero'}} />
                                          </g>
                                          ...
                                          <g id="g766" transform="matrix(1,0,0,1,366.161,682.955)">
                                            <path className="altGrey" id="path768" d="M0.016,0L-5.415,0L-1.776,3.639L-1.574,3.85C0.642,6.066 4,6.445 6.607,4.987C5.797,2.109 3.153,0 0.016,0Z" style={{fill:'currentColor',fillRule:'nonzero'}} />
                                          </g>
                            ...
                            <div className="icon__row">
                                ...
                                <div className="technologies__icon" title="Google Analytics">
                                  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="192px" height="192px" viewBox="0 0 192 192" enableBackground="new 0 0 192 192">
                                    <rect x="0" y="0" fill="none" width="192" height="192" />
                                      <g>
                                        ...
                                        <g>
                                          <path fill="currentColor" d="M75,96v65c0,14.77,10.19,23,21,23c10,0,21-7,21-23V97c0-13.54-10-22-21-22S75,84.33,75,96z" />
                                        </g>
                                        <g>
                                          <circle fill="currentColor" cx="41" cy="163" r="21" />
                                        </g>
                                      </g>
                                  </svg>
                                </div>
                                ...
                                <div className="technologies__icon" title="Localist">
                                  ...
                                  <svg width="122" height="59" viewBox="0 0 122 59" xmlns="http://www.w3.org/2000/svg">
                                    <g fill="none" fillRule="evenodd">
                                      ...
                                      <path d="M104.402 28.652c-.02 1.161-1.14 2.114-2.493 2.124-17.411.103-34.71-.046-51.895-.444-1.338-.028-2.289-1.253-2.124-2.73.936-8.456 1.85-16.84 2.741-25.16.158-1.455 1.31-2.481 2.576-2.298a1639.25 1639.25 0 0 0 49.214 6.244c1.282.146 2.314 1.194 2.3 2.344-.084 6.61-.19 13.25-.319 19.92" fill="#78C5D3" />
