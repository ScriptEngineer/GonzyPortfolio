    ...
    return (
        <div className="wrapper">
            ...
            <nav className="nav">
                ...
                <div className="nav__section nav__branding">
                    <img className="left" id="navLogo" src={urlImgLogo}/>
                </div>
                    ...
                    <div className="showcase__demos">
                      ...
                      <div className="showcase__card showcase__card--terry">
                        <div className="showcase__card__content">
                          ...
                          <p className="showcase__card__description">
                            Terry is an AI-powered database assistant designed to make interacting with your PostgreSQL databases intuitive and conversational. Instead of writing complex SQL queries, simply describe what you need in plain English—Terry translates your requests into optimized queries and returns clear, actionable results.
                            <br />
                            <br />
                            Whether you need to explore your data, generate reports, troubleshoot performance issues, or understand your schema, Terry handles it all. He can explain query results, suggest indexes, identify anomalies, and even help you design new tables or migrations.
                            <br />
                            <br />
                            Terry integrates securely with your existing database infrastructure, respecting your access controls and audit requirements. He's perfect for developers who want to speed up their workflow, analysts who need quick insights, and teams who want to democratize data access without compromising security.
                          </p>
